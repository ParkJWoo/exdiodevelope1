            ...
            if (hit.collider != null)
            {
                ...
                if (currentInterObjScript.openable)
                {
                    ...
                    if (currentInterObjScript.lockedByStbox)
                    {
                        //우리가 잠금을 풀기위해 필요한 오브젝트를 갖고있는지 체크하기위함
                        //필요한 아이템을 우리 인벤토리에서 찾아본다 - 찾으면 잠금을 품
                        if (inventory.FindItemByType("mirror_pass"))
                        {
                            GameObject pass = inventory.FindItemByType("mirror_pass");
                    ...
                    if (currentInterObjScript.lockedByBackdoor)
                    {
                        //우리가 잠금을 풀기위해 필요한 오브젝트를 갖고있는지 체크하기위함
                        //필요한 아이템을 우리 인벤토리에서 찾아본다 - 찾으면 잠금을 품
                        if (inventory.FindItemByType("BackdoorKey"))
                        {
                ...
                {
                    if (inventory.FindItemByType("spray"))
                    {
